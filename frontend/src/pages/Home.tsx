...
export default function Home() {
  ...
  // Array de slides com imagens (locais e externas)
  const slides = [
  ...
  // Navegação suave para a secção "Como usar"
    ...
    <>
      ...
      <main>
        ...
        <section className="py-16 bg-white">
          <div className="container-custom">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-secundaria mb-12">
              Porquê escolher-nos?
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="text-center p-6 rounded-2xl shadow-lg hover:shadow-xl transition transform hover:-translate-y-2 duration-300"
                >
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition transform hover:-translate-y-2 duration-300"
                >
            ...
            <div className="text-center mt-12">
              <button
                onClick={() => handleProtectedClick("/cardapio")}
                className="bg-secundaria text-white px-8 py-3 rounded-full text-lg font-semibold hover:bg-primaria transition"
              >
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                <div className="text-5xl mb-4 bg-primaria/10 w-20 h-20 rounded-full flex items-center justify-center mx-auto">1</div>
              ...
              <div className="text-center p-6">
                <div className="text-5xl mb-4 bg-primaria/10 w-20 h-20 rounded-full flex items-center justify-center mx-auto">2</div>
              ...
              <div className="text-center p-6">
                <div className="text-5xl mb-4 bg-primaria/10 w-20 h-20 rounded-full flex items-center justify-center mx-auto">3</div>
          ...
          <div className="container-custom grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 text-lg mb-6">
                Há mais de 2 anos, o Origens do Sabor nasceu com o propósito de trazer à mesa o melhor da gastronomia moçambicana.
              </p>
              <p className="text-gray-700 text-lg mb-6">
                Localizado no coração de Chimoio, somos referência em qualidade, atendimento e criatividade. Cada prato é preparado com ingredientes frescos e muito carinho.
              </p>
              ...
              <div>
                <div className="mb-6">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 mt-2 bg-[#25D366] text-white px-4 py-2 rounded-full hover:bg-[#128C7E] transition"
                  >
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-700">
                    Rua Cidade de Lichinga, em frente ao Tribunal Judicial,
                    <br />
                    Chimoio, Moçambique
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-4">
                    <a href="#" className="text-primaria hover:text-secundaria transition">Instagram</a>
                    <a href="#" className="text-primaria hover:text-secundaria transition">Facebook</a>
                    <a href="#" className="text-primaria hover:text-secundaria transition">WhatsApp</a>
                  </div>
                </div>
              </div>
      ...
      {/* Estilos adicionais para as animações (caso não estejam no globals.css) */}
      <style>{`
        @keyframes fadeInUp {
          from {
            opacity: 0;
